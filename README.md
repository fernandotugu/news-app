...
apoa o comando acima, ira gerar um diretorio da raiz da pasta application chamado covarage, basta acessar essa pasta e abrir o arquivo index.html externamente no browser de preferencia
